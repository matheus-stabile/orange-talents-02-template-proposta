...
import com.github.matheusstabile.nossocartao.proposta.carteiras.CarteiraRequest;
...
public interface CartaoClient {
    ...
    ResponseEntity associaCarteira(@RequestBody Map carteiraRequest, @PathVariable String idCartao);
}
